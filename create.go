...
Where "<container-id>" is a name for the new instance of the container.
...
command to run when the container is started. To change the command, edit the
args parameter of the spec. See "runc spec --help" for more details.`,
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:  "bundle, b",
			Value: "",
